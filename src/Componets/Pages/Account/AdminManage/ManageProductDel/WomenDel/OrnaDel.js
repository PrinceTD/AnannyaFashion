...
function OrnaDel() {
    ...
    useEffect(() => {
        fetch(`https://powerful-wildwood-87881.herokuapp.com/orna`)
            .then((res) => res.json())
    ...
    const handleDeleteConfirm = (id) => {
        ...
        if (confirm) {
            fetch(
                `https://powerful-wildwood-87881.herokuapp.com/orna/${id}`,
                {
                    method: "DELETE",
                }
            )
